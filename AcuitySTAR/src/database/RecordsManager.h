...
public:
    ...
    QGuiApplication commitData(QSessionManager& manager);
    QString createQStringForTab(int fileType, int startYear, int endYear, const std::vector<std::string> &sortFields, char filterStart, char filterEnd);
    QList<QVariant> createHeadersListForTab(int fileType, std::string topLevel);
    ...
    std::vector<std::pair<std::string, double>> getCountTuple(int startYear, int endYear,
